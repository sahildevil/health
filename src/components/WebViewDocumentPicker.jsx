...
const WebViewDocumentPicker = ({visible, onClose, onFilesSelected}) => {
  ...
  const htmlContent = `
    ...
    <body>
      <div class="title">Select Document</div>
      ...
      <div class="upload-btn-wrapper">
        <div class="btn">
          ...
          <span style="margin-top: 8px;">Choose Document</span>
        </div>
        <input type="file" id="fileInput" multiple onchange="handleFiles(this.files)" accept=".pdf,image/*,video/*" />
      </div>
